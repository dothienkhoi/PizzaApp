...
/** @hide */
	...
	public BindableButtonEx (android.content.Context p0, android.util.AttributeSet p1, int p2)
	{
		super (p0, p1, p2);
		if (getClass () == BindableButtonEx.class) {
			mono.android.TypeManager.Activate ("Windows.UI.Xaml.Controls.BindableButtonEx, Uno.UI", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, System.Private.CoreLib", this, new java.lang.Object[] { p0, p1, p2 });
		}
	}
